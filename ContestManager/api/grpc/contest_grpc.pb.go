...
func (c *contestServiceClient) CreateContestWithProblems(ctx context.Context, in *CreateContestWithProblemsRequest, opts ...grpc.CallOption) (*CreateContestResponse, error) {
	out := new(CreateContestResponse)
	err := c.cc.Invoke(ctx, ContestService_CreateContestWithProblems_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contestServiceClient) SubmitSolution(ctx context.Context, in *SubmitSolutionRequest, opts ...grpc.CallOption) (*SubmitSolutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, ContestService_SubmitSolution_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contestServiceClient) GetSubmissions(ctx context.Context, in *GetSubmissionsRequest, opts ...grpc.CallOption) (*GetSubmissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ContestService_GetSubmissions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contestServiceClient) GetLeaderboard(ctx context.Context, in *GetLeaderboardRequest, opts ...grpc.CallOption) (*GetLeaderboardResponse, error) {
	...
	err := c.cc.Invoke(ctx, ContestService_GetLeaderboard_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contestServiceClient) StreamLeaderboard(ctx context.Context, in *StreamLeaderboardRequest, opts ...grpc.CallOption) (ContestService_StreamLeaderboardClient, error) {
	stream, err := c.cc.NewStream(ctx, &ContestService_ServiceDesc.Streams[0], ContestService_StreamLeaderboard_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &contestServiceStreamLeaderboardClient{stream}
...
type ContestService_StreamLeaderboardClient interface {
	Recv() (*LeaderboardUpdate, error)
	grpc.ClientStream
}

type contestServiceStreamLeaderboardClient struct {
	grpc.ClientStream
}

func (x *contestServiceStreamLeaderboardClient) Recv() (*LeaderboardUpdate, error) {
	m := new(LeaderboardUpdate)
...
func _ContestService_StreamLeaderboard_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ContestServiceServer).StreamLeaderboard(m, &contestServiceStreamLeaderboardServer{stream})
}

type ContestService_StreamLeaderboardServer interface {
	Send(*LeaderboardUpdate) error
	grpc.ServerStream
}

type contestServiceStreamLeaderboardServer struct {
	grpc.ServerStream
}

func (x *contestServiceStreamLeaderboardServer) Send(m *LeaderboardUpdate) error {
